...
Podemos separar o torque em duas componentes: o torque de alinhamento (ou síncrono), 
devido à interação com a força contra-eletromotriz, e o torque de relutância, devido à assimetria do rotor:

\begin{equation}
    T_e = 
    \underbrace{\frac{3}{2} P \frac{e_d i_d + e_q i_q}{\omega_e}}_{T_{sinc}} + 
    \underbrace{\frac{3}{2} P (L_d - L_q) i_d i_q}_{T_{rel}}
\end{equation}
