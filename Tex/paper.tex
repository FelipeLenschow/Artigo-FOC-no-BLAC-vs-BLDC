...
visto no anexo \ref{app:simulator}. A estrutura 
...
\begin{itemize}
    ...
    classes distintas para \texttt{BLDCMotor} e \texttt{BLACMotor}, ambas herdando 
    ou seguindo uma interface comum que expõe métodos para o cálculo da dinâmica 
...
O perfil de simulação seque o padrão desenvolvido em \cite{b3}, que consiste em:
\begin{itemize}
...
no caso do BLDC. Já para o torque, observa-se que o motor BLDC apresenta um ripple 
